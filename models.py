...
class Model(nn.Module):
    def __init__(self, filename_obj, args):
        ...
        self.tex_laplacian_loss = sr.TexLaplacianLoss(self.decoder.faces)
        self.flatten_loss = sr.FlattenLoss(self.decoder.faces)

    def model_param(self):
        return list(self.encoder.parameters()) + list(self.decoder.parameters()) + list(self.col_gen.parameters())
    ...
    def reconstruct(self, images):
        ...
        if self.tex_gen:
            ...
            textures = torch.matmul(mat1, col_selection).permute(0, 2, 1)
